...
#include "differential_drive_controller/diffbot_system.hpp"
...
hardware_interface::return_type differential_drive_controller ::DiffBotSystemHardware::write(
  const rclcpp::Time & /*time*/, const rclcpp::Duration & /*period*/)
{
  // BEGIN: This part here is for exemplary purposes - Please do not copy to your production code
  std::stringstream ss;
...
PLUGINLIB_EXPORT_CLASS(
  differential_drive_controller::DiffBotSystemHardware, hardware_interface::SystemInterface)
